...
Este projeto tem como objetivo cadastrar a sua coleção de cartas de Magic: The Gathering e filtrar a coleção.

## Endereço de Deploy - GitHub Pages

https://github.com/OvoKore/magic-register
...
- Executar a API Fake (JSON Server) via um dos seguintes comandos: 
  ...
  - Ou via Execução explícita: `json-server --watch db.json --id --routes routes.json`
